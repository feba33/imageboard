      ...
      <main role="main">
        <section id="text">
          ...
          <article id="text__comments">
            ...
            <div>
              ...
              <p>
                <a href="#!">
                  This is a text link. But it should not be displayed in a
                  comment
                </a>
                .
              </p>
              ...
              <p>
                <em>
                  This text has added emphasis. But, it should not be displayed
                  in a comment
                </em>
              </p>
            </div>
        ...
        <section id="embedded">
          ...
          <article id="embedded__progress">
            ...
            <div>
              <progress max='100' value='40'>progress</progress>
            </div>
            <footer>
              <p>
                <a href="#top">[Top]</a>
